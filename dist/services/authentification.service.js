...
class AuthentificationService {
    ...
    authenticate(info) {
        return __awaiter(this, void 0, void 0, function* () {
            const adminCredential = yield this.getBosToAdminCredential();
            if (!adminCredential)
                return;
            const isUser = info.userName && info.password ? true : false;
    ...
    editBosCredential(bosCredential) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (bosCredential.TokenBosAdmin)
                contextInfo.mod_attr("tokenBosAdmin", bosCredential.TokenBosAdmin);
            if (bosCredential.name)
                contextInfo.mod_attr("bosName", bosCredential.name);
            if (bosCredential.id)
    ...
    sendDataToAdmin(update = false) {
        return __awaiter(this, void 0, void 0, function* () {
            const bosCredential = yield this.getBosToAdminCredential();
            if (!bosCredential)
    ...
    getJsonData() {
        return __awaiter(this, void 0, void 0, function* () {
            return {
                ...
                organList: yield this._formatOrganList(),
    ...
    _getRequestBody(update, bosCredential, adminCredential) {
        return __awaiter(this, void 0, void 0, function* () {
            return JSON.stringify(Object.assign({ TokenBosAdmin: bosCredential.tokenBosAdmin, platformId: bosCredential.idPlateform, jsonData: yield this.getJsonData() }, (!update && {
